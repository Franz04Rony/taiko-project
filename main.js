...
const nombres = ["Nadie te preguntó", "Reflect", "Charles", "Charles", "The desolation of spring"];
const images = ["images/nadie_te_pregunto.webp", "images/reflect.jpg", "images/charles1.jpg", "images/charles.jpg", "images/the_desolation_of_spring.jpg"];
const dif = ["Muzukashi", "Muzukasi", "Oni", "Kantan", "wtf"];
const songs = ["songs/nadie_te_pregunto.mp3", "songs/reflect.mp3", "songs/charles.mp3", "songs/charles.mp3", "songs/the_desolation_of_spring.mp3"];
const times =[0,1,2,3,4];
let delays = [3581, 8970, 4020, 5178, 3901]
let start = [0,0,0,0,1000] //retraso para que empiece la canción
//////
let actual_song = [];
